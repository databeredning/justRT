...
OBJS := $(addprefix $(OBJDIR)/,startup_cm7.o Vector_Table.o system.o main.o examples/heartbeat.o examples/sync_producer_consumer.o examples/semaphore_event.o examples/mutex_contention.o kernel/task.o kernel/port_cm7.o kernel/fault.o kernel/sync.o board/board.o)
